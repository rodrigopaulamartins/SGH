...
begin
   ...
   begin
      Application.MessageBox('Informe o tipo d tabela.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBLookupComboBox1.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a descrição do procedimento.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit4.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a descrição simplificada.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit5.SetFocus;
      abort;
   end;
   //
