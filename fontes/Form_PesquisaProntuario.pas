...
begin
     ...
     begin
        ...
        begin
           ...
           mensagem := 'Tem certeza que deseja excluir o prontuário: ' + QPesqProntuario.FieldByName('NOME_COMPLETO').AsString + '?';
           FAvisoExclusao.Label1.Caption := 'ATENÇÃO - Exclusão de Prontuário';
