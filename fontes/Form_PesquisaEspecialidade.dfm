object FPesquisaEspecialidade: TFPesquisaEspecialidade
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object DPesqEspecialidade: TDataSource
    DataSet = QPesqEspecialidade
    Left = 416
    Top = 311
  end
  object QPesqEspecialidade: TZQuery
    ...
    Left = 376
    Top = 311
    object QPesqEspecialidadecodigo: TIntegerField
      FieldName = 'codigo'
      Required = True
    end
    object QPesqEspecialidadedescricao: TWideStringField
      FieldName = 'descricao'
      Size = 50
    end
    object QPesqEspecialidadecod_cbo: TWideStringField
      FieldName = 'cod_cbo'
      Size = 6
    end
    object QPesqEspecialidadecod_cbosus: TWideStringField
      FieldName = 'cod_cbosus'
      Size = 6
    end
    object QPesqEspecialidadebtn_alterar: TWideStringField
      FieldName = 'btn_alterar'
      Size = 1
    end
    object QPesqEspecialidadebtn_excluir: TWideStringField
      FieldName = 'btn_excluir'
      Size = 1
    end
  end
