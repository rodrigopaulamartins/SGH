...
begin
   ...
   begin
      Application.MessageBox('Informe o nome completo do usuário.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe o login para acesso ao sistema.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit4.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a senha de acesso ao sistema.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit5.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Senha deve conter mais que três caracteres.','Número de Caracteres', MB_ICONEXCLAMATION+MB_OK);
      DBEdit5.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe o e-mail.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit6.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('E-mail inválido.','E-mail Inválido', MB_ICONEXCLAMATION+MB_OK);
      DBEdit6.SetFocus;
      abort;
   end;
   //
