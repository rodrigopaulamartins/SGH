...
begin
   if Label1.Caption = 'ATENÇÃO - Exclusão de Usuário' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de Prontuário' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   //
   if Label1.Caption = 'ATENÇÃO - Exclusão de Cliente/Fornecedor' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão da Especialidade' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de Prestador de Serviços' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão da Credenciamento' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de convênio' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão porte procedimento' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão categoria de atendimento' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de Diagnóstico CID-10' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de ato médico' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de especialidade médica' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
   ...
   if Label1.Caption = 'ATENÇÃO - Exclusão de Procedimento' then
   begin
      QDelete.Close;
      QDelete.SQL.Clear;
