...
begin
   ...
   begin
      Application.MessageBox('Informe a descrição do ato médico.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a porcentagem para o calculo.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit4.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe o tipo de pagamento.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
