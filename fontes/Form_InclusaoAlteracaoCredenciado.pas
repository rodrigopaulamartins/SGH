...
type
  TFIncluscaoAlteracaoCredenciado = class(TForm)
    ...
    QPesqConvênio: TZQuery;
    QPesqConvênioCODIGO: TIntegerField;
    QPesqConvênioRAZAO_SOCIAL: TWideStringField;
...
begin
   ...
   begin
      ...
      begin
         Application.MessageBox('Informe o número do contrato do prestador na operadora.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
         DBEdit1.SetFocus;
         abort;
      end;
