object FInclusaoAlteracaoPortePrc: TFInclusaoAlteracaoPortePrc
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 352
  ...
  object Panel1: TPanel
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      DataSource = FInclusaoAlteracaoConvenio.DCadPortePrc
      KeyField = 'codigo'
      ListField = 'descricao'
      ListSource = DPesqCategoria
      TabOrder = 1
    ...
    object DBEdit9: TDBEdit
      ...
      Width = 109
      Height = 23
      DataField = 'vlr_sadt_credenciado'
      DataSource = FInclusaoAlteracaoConvenio.DCadPortePrc
      TabOrder = 11
  ...
  object DPesqCategoria: TDataSource
    DataSet = QPesqCategoria
    Left = 376
    Top = 278
  end
  object QPesqCategoria: TZQuery
    Connection = DM.Conexao
    SQL.Strings = (
      'SELECT * FROM CAD_CONVENIO_CATEGORIA'
      'ORDER BY DESCRICAO')
    Params = <>
    Left = 344
    Top = 278
    object QPesqCategoriacodigo: TIntegerField
      FieldName = 'codigo'
      Required = True
    end
    object QPesqCategoriaidprestador: TIntegerField
      FieldName = 'idprestador'
    end
    object QPesqCategoriadescricao: TWideStringField
      FieldName = 'descricao'
      Size = 100
    end
    object QPesqCategoriainativo: TWideStringField
      FieldName = 'inativo'
      Size = 1
    end
    object QPesqCategoriaidmodalidade: TIntegerField
      FieldName = 'idmodalidade'
    end
    object QPesqCategoriaidtabsh: TIntegerField
      FieldName = 'idtabsh'
    end
    object QPesqCategoriaidtabsp: TIntegerField
      FieldName = 'idtabsp'
    end
    object QPesqCategoriaidtabsadt: TIntegerField
      FieldName = 'idtabsadt'
    end
    object QPesqCategoriaidtabmedicamento: TIntegerField
      FieldName = 'idtabmedicamento'
    end
    object QPesqCategoriaidtabemateriais: TIntegerField
      FieldName = 'idtabemateriais'
    end
    object QPesqCategoriabtn_alterar: TWideStringField
      FieldName = 'btn_alterar'
      Size = 1
    end
    object QPesqCategoriabtn_excluir: TWideStringField
