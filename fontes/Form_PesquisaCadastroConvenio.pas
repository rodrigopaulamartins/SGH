...
begin
     ...
     begin
        ...
        begin
           ...
           mensagem := 'Tem certeza que deseja excluir o convênio? ' + QPesqConvenio.FieldByName('NOME_COMPLETO').AsString + '?';
           FAvisoExclusao.Label1.Caption := 'ATENÇÃO - Exclusão de convênio';
