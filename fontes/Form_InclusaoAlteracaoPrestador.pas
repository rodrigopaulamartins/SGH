...
begin
     ...
     begin
        ...
        begin
           ...
           mensagem := 'Tem certeza que deseja excluir o prontuário: ' + QCadEspec.FieldByName('DESCRICAO').AsString + '?';
           FAvisoExclusao.Label1.Caption := 'ATENÇÃO - Exclusão da Especialidade';
...
begin
     ...
     begin
        ...
        begin
           ...
           FAvisoExclusao.Label1.Caption := 'ATENÇÃO - Exclusão da Credenciamento';
