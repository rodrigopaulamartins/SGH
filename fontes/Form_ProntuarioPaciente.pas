...
begin
   //faz as validações se o campo esta preenchido
   if DBEdit2.Text = '' then
   begin
      Application.MessageBox('Informe o nome do paciente.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   //
   ...
   begin
      Application.MessageBox('Número de caracteres informado não atende ao nome.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   //
   ...
   begin
      Application.MessageBox('Informe a data de nascimento.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit7.SetFocus;
      abort;
   end;
   //
   ...
   begin
      Application.MessageBox('Informe a nacionalidade do paciente.','Campo obrigatório', MB_ICONWARNING+MB_OK);
   ...
   begin
      Application.MessageBox('Informe o sexo do paciente.','Campo obrigatório', MB_ICONWARNING+MB_OK);
   ...
   begin
      Application.MessageBox('Informe estado civil do paciente.','Campo obrigatório', MB_ICONWARNING+MB_OK);
   ...
   begin
      Application.MessageBox('Informe a raça/cor do paciente.','Campo obrigatório', MB_ICONWARNING+MB_OK);
   ...
   begin
      Application.MessageBox('Informe o nome da mãe do paciente.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit14.SetFocus;
      abort;
   end;
   //
   ...
   begin
      ...
      begin
         Application.MessageBox('Paciente maior que 60 anos ou menor de 18 anos é obrigatório um responsável.','Campo obrigatório', MB_ICONWARNING+MB_OK);
         DBEdit33.SetFocus;
