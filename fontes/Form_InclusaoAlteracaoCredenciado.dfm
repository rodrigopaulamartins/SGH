object FIncluscaoAlteracaoCredenciado: TFIncluscaoAlteracaoCredenciado
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 289
  ...
  object Panel1: TPanel
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      DataSource = FInclusaoAlteracaoPrestador.DCadCredenciado
      KeyField = 'CODIGO'
  ...
  object DPesqConvenio: TDataSource
    DataSet = QPesqConvênio
    Left = 496
    Top = 206
  end
  object QPesqConvênio: TZQuery
    Connection = DM.Conexao
    SQL.Strings = (
      'SELECT A.CODIGO, B.RAZAO_SOCIAL'
      ' FROM CAD_CONVENIO A'
    ...
    Left = 456
    Top = 214
    object QPesqConvênioCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object QPesqConvênioRAZAO_SOCIAL: TWideStringField
