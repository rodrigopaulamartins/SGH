...
begin
   ...
   begin
      Application.MessageBox('Informe CPF ou CNPJ.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   //
   ...
   begin
      Application.MessageBox('Informe nome ou razão social.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit3.SetFocus;
      abort;
   end;
   //
   ...
   begin
      Application.MessageBox('Informe o nome fantasia.','Campo obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit4.SetFocus;
      abort;
   end;
   //
   ...
   begin
      Application.MessageBox('Selecione o ramo/atividade.','Campo obrigatório', MB_ICONWARNING+MB_OK);
