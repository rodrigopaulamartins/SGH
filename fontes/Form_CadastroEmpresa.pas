...
begin
   ...
   begin
      Application.MessageBox('Informe a data do cadastro.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe o tipo de inscrição.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBLookupComboBox1.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe o nome fantasia.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit3.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a razão Social.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit4.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a situação cadastral.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
   ...
   begin
      Application.MessageBox('Informe o motivo da situação cadastral.','Obrigatório', MB_ICONINFORMATION+MB_OK);
