...
begin
   ...
   begin
      Application.MessageBox('Informe a descrição da especialidade.','Campo Obrigatório', MB_ICONWARNING+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   if DBLookupComboBox1.Text = '' then
   begin
      Application.MessageBox('Selecione o CBO - SUS.','Campo Obrigatório', MB_ICONWARNING+MB_OK);
      DBLookupComboBox1.SetFocus;
      abort;
   end;
   if DBLookupComboBox2.Text = '' then
   begin
      Application.MessageBox('Selecione o CBO - TISS.','Campo Obrigatório', MB_ICONWARNING+MB_OK);
