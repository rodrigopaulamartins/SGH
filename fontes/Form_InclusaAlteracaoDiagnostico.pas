...
begin
   ...
   begin
      Application.MessageBox('Informe o código do CID.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit1.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe a descrição do diagnóstico.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit2.SetFocus;
      abort;
   end;
   ...
   begin
      Application.MessageBox('Informe o código do Grupo do Cid.','Obrigatório', MB_ICONEXCLAMATION+MB_OK);
      DBEdit3.SetFocus;
      abort;
   end;
   //
