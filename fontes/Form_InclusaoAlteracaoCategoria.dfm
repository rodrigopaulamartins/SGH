object FInclusaoAlteracaoCategoria: TFInclusaoAlteracaoCategoria
  Left = 0
  Top = 0
  BorderIcons = []
  ClientHeight = 352
  ...
  object Panel1: TPanel
    ...
    object Label4: TLabel
      ...
      Width = 168
      Height = 15
      Caption = 'Tabela servi'#231'os Hospitalares'
      FocusControl = DBEdit1
    end
    object Label5: TLabel
      ...
      Width = 169
      Height = 15
      Caption = 'Tabela servi'#231'os profissionais'
      FocusControl = DBEdit1
    end
    ...
    object Label8: TLabel
      ...
      Width = 166
      Height = 15
      Caption = 'Tabelas de materiais / OPME'
      FocusControl = DBEdit1
    end
    object Edit1: TEdit
      Left = 16
    ...
    object DBEdit1: TDBEdit
      ...
      Height = 23
      DataField = 'descricao'
      DataSource = FInclusaoAlteracaoConvenio.DCadCategoria
      TabOrder = 1
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      Width = 274
      Height = 23
      DataSource = DPesqModalidadeAte
      KeyField = 'codigo'
      ListField = 'descricao'
      ListSource = DPesqModalidadeAte
      TabOrder = 2
  ...
  object QPesqModalidade: TZQuery
    Connection = DM.Conexao
    SQL.Strings = (
      'SELECT * FROM ARQ_MODALIDADE_ATE')
    Params = <>
    Left = 280
    Top = 24
    object QPesqModalidadecodigo: TIntegerField
      FieldName = 'codigo'
      Required = True
    end
    object QPesqModalidadecod_mod: TWideStringField
      FieldName = 'cod_mod'
      Size = 2
    end
    object QPesqModalidadedescricao: TWideStringField
      FieldName = 'descricao'
      Size = 50
    end
  end
  object DPesqModalidadeAte: TDataSource
    DataSet = QPesqModalidade
    Left = 312
    Top = 22
  end
end
