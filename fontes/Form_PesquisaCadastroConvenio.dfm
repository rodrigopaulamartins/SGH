object FPesquisaCadastroConvenio: TFPesquisaCadastroConvenio
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 197
      Height = 19
      Caption = 'CADASTRO DE CONV'#202'NIOS'
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Descri'#231#227'o do Conv'#234'nio'
          Width = 528
          Visible = True
        end
        item
  ...
  object QPesqConvenio: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT A.CODIGO, A.BTN_ALTERAR, A.INATIVO, A.BTN_EXCLUIR, B.RAZA' +
        'O_SOCIAL'
      ' FROM CAD_CONVENIO A'
    ...
    object QPesqConvenioBTN_ALTERAR: TWideStringField
      FieldName = 'BTN_ALTERAR'
      ReadOnly = True
      Size = 1
    end
    object QPesqConvenioBTN_EXCLUIR: TWideStringField
      FieldName = 'BTN_EXCLUIR'
      ReadOnly = True
      Size = 1
    end
