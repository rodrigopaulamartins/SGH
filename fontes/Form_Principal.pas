...
var
  ...
  i: integer;
begin
  // busca pelo nome. O nome da aba será "TS" + <Nome>
  // Ex: Se o form é o TfrmClientes, a aba será TSTfrmClientes.
  // Já o caption da aba é o mesmo do form.
  ...
  // se passar daqui, aba não existe
...
begin
   ...
   if TreeView1.Selected.Text = 'Prontuários' then
   begin
      CriarAba(TFPesquisaProntuario);
   end;
   //abre o fomulario de cadastro do usuário
   if TreeView1.Selected.Text = 'Usuários' then
   begin
      CriarAba(TFUsuarios);
   end;
   ...
   //abre o fomulario de cadastro do prestador de serviço
   if TreeView1.Selected.Text = 'Prestadores' then
   begin
      CriarAba(TFPesquisaPrestadorServico);
   end;
   //abre o fomulario de cadastro de convênios
   if TreeView1.Selected.Text = 'Convênios' then
   begin
   ...
   //abre o fomulario de cadastro de Ato médico
   if TreeView1.Selected.Text = 'Ato Médico' then
   begin
